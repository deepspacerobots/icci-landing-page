...
class WPVite {
	...
	public array $jsDeps = [];
	public function __construct(bool $isChild, string $viteRoot) {
		...
		$viteRootEnv = isset($viteRoot) ? $dir . $viteRoot : $dir;
		$env = parse_ini_file($viteRootEnv . '.env');
		$this->distUri = $dirUri . $viteRoot . $env['VITE_OUTPUT_DIR'];
		$this->distPath = $dir . $viteRoot . $env['VITE_OUTPUT_DIR'];
